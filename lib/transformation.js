...
exports.restAPI = function(transformation){
    return exports.generateTransformation(transformation, require("./fs").defaultRestStrategy);
}
...
exports.interceptor = function(transformation){
    return exports.generateTransformation(transformation, require("./interceptor.js").InterceptorStrategy);
}

exports.cs = function(transformation){
    return exports.generateTransformation(transformation, require("./cs.js").CSStrategy);
}
