...
function RestStrategy(codeExecutionStrategy, httpServer, generalContext){
...
exports.newRestStrategy  = function(stepFunctionStrategy, httpServer, context){
    return new RestStrategy(stepFunctionStrategy, httpServer, context);
}